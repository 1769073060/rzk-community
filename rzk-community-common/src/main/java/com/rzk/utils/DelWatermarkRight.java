 ...
 */
@Slf4j
public class DelWatermarkRight {

	private String ffmpegVideos;
	private  int videoWidth;
	private  int videoHeight;

	public DelWatermarkRight(String ffmpegVideos, int videoWidth, int videoHeight) {
		super();
	...
	public int convertor(String videoInputPath,String videoOutPutPth) throws Exception {
		...
		command.add("\"delogo=x=" + width + ":y=" + height + ":w=250:h=100:show=0\"");
		command.add("-y");
		command.add(videoOutPutPth);
		log.info("rightConvertor:");
