package com.rzk.controller.chat.netty;

import com.rzk.controller.chat.bean.ReceivedMessages;
import com.rzk.controller.chat.bean.SendMessages;
...
public class chatHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame msg) throws Exception {
        ...
        if("connection".equals(sendMessages.getType())){
            // 保存当前的连接信息
            com.rzk.controller.chat.netty.UserChannelRel.put(sendMessages.getNickName(), currentChannel);
            // 组装用户接收的消息
